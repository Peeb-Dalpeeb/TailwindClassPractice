...
export function Item({ item, Name, price, description, imageURL }: ItemProps) {
  return (
    <article className="mx-auto flex w-2/3 flex-col items-center gap-6 rounded-lg border-1 border-gray-200 bg-white p-4 md:flex-row md:gap-8">
      <img
        src={imageURL}
        alt={Name}
      ...
      <div className="flex w-full flex-col gap-4 md:w-auto">
        ...
        <div className="flex items-center gap-8">
          ...
          <button
            type="button"
            className="text-pie-grey hover:text-pie-charcoal text-sm underline underline-offset-2"
          >
            Delete
          </button>
        </div>
